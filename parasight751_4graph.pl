...
#031007 added graph3 and graph4 option
...
use vars qw(@g1 @g2 @g3 @g4);   #graph1 graph2 graph3 gragh4
...
-graph3 [filepath1:filepath2:etc]
   adds another line to the graph scale
-graph4 [filepath1:filepath2:etc]
   adds another line to the graph scale
OPTIONAL COMMANDS
...
if ( &GetOptions(\%newopt, "in=s", "align=s", "showseq=s","showsub=s","color=s",'colorsub=s', "extra=s","arrangeseq=s","arrangesub=s","options=s",
		 "template=s","graph1=s","graph2=s","graph3=s","graph4=s","showqueryonly","quiet","minload", "precode=s","die","help") ) {
...
if ($newopt{'in'}) {
  ...
  $opt{'graph3'} = $newopt{'graph3'};
  $opt{'graph4'} = $newopt{'graph4'};
}
...
my @todefine=(
	      ...
	      'begin',	'graph3_label_color' , 'red' ,  '[color] of graph3 scale labels'  ,
	      'begin',	'graph3_label_decimal' , 2 ,  '[integer] number of decimal point to round graph3 scale label'  ,
	      'begin',	'graph3_label_fontsize' , 10 ,  '[integer] point size of graph3 scale labels'  ,
	      'begin',	'graph3_label_multiplier' , 1 ,  '[float] graph3 scale label multiplier'  ,
	      'begin',	'graph3_label_offset' , 8 ,  '[integer] horizontal offset of graph3 scale labels'  ,
	      'begin',	'graph3_label_on' , 1 ,  '[0|1] toggles graph3 scale labels off and n'  ,
	      'begin',	'graph3_line_color' , 'red' ,  '[color] of graph3 connecting lines'  ,
	      'begin',	'graph3_line_on' , 1 ,  '[0|1] toggles graph3 connecting lines off and on'  ,
	      'begin',	'graph3_line_smooth' , 0 ,  '[0|1] toggles graph3 connecting line smoothing off and on',
	      'begin',	'graph3_line_width' , 1 ,  '[integer] thickness of graph3 connecting lines'  ,
	      'begin',	'graph3_max' , 1000 ,  '[integer] maximum value for graph3 scale'  ,
	      'begin',	'graph3_min' , -1000 ,  '[integer] minimum value for graph3 scale'  ,
	      'begin',	'graph3_on' , 0 ,  '[0|1] toggles graph3_on'  ,
	      'begin',	'graph3_point_fill_color' , 'red' ,  '[color] of interior of graph3 points'  ,
	      'begin',	'graph3_point_on' , 1 ,  '[0|1] toggles graph3 point drawing on and off'  ,
	      'begin',	'graph3_point_outline_color' , 'red' ,  '[color] of graph3 point outline'  ,
	      'begin',	'graph3_point_outline_width' , 1 ,  '[integer] thickness of graph3 point outline'  ,
	      'begin',	'graph3_point_size' , 2 ,  '[integer] radius size of graph 2 points'  ,
	      'begin',	'graph3_tick_color' , 	'black' ,  '[color] of graph3 vertical scale ticks'  ,
	      'begin',	'graph3_tick_length' , 	6 ,  '[integer] length of graph3 vertical scale ticks'  ,
	      'begin',	'graph3_tick_offset' , 5 ,  '[integer] horizontal offset of graph3 vertical scale ticks'  ,
	      'begin',	'graph3_tick_on' , 1 ,  '[0|1] toggles graph3 vertical scale ticks on and off'  ,
	      'begin',	'graph3_tick_width' , 	3 ,  '[integer] thickness of graph3 vertical scale ticks'  ,
	      'begin',	'graph3_vline_color' , 'black' ,  '[color] of graph3 vertical scale line'  ,
	      'begin',	'graph3_vline_on' , 1 ,  '[0|1] toggles graph3 vertical scale line off and on'  ,
	      'begin',	'graph3_vline_width' , 2 ,  '[integer] thickness of graph3 vertical scale line'  ,
	      'begin',	'graph4_label_color' , 'red' ,  '[color] of graph4 scale labels'  ,
	      'begin',	'graph4_label_decimal' , 2 ,  '[integer] number of decimal point to round graph4 scale label'  ,
	      'begin',	'graph4_label_fontsize' , 10 ,  '[integer] point size of graph4 scale labels'  ,
	      'begin',	'graph4_label_multiplier' , 1 ,  '[float] graph4 scale label multiplier'  ,
	      'begin',	'graph4_label_offset' , 8 ,  '[integer] horizontal offset of graph4 scale labels'  ,
	      'begin',	'graph4_label_on' , 1 ,  '[0|1] toggles graph4 scale labels off and n'  ,
	      'begin',	'graph4_line_color' , 'red' ,  '[color] of graph4 connecting lines'  ,
	      'begin',	'graph4_line_on' , 1 ,  '[0|1] toggles graph4 connecting lines off and on'  ,
	      'begin',	'graph4_line_smooth' , 0 ,  '[0|1] toggles graph4 connecting line smoothing off and on',
	      'begin',	'graph4_line_width' , 1 ,  '[integer] thickness of graph4 connecting lines'  ,
	      'begin',	'graph4_max' , 1000 ,  '[integer] maximum value for graph4 scale'  ,
	      'begin',	'graph4_min' , -1000 ,  '[integer] minimum value for graph4 scale'  ,
	      'begin',	'graph4_on' , 0 ,  '[0|1] toggles graph4_on'  ,
	      'begin',	'graph4_point_fill_color' , 'red' ,  '[color] of interior of graph4 points'  ,
	      'begin',	'graph4_point_on' , 1 ,  '[0|1] toggles graph4 point drawing on and off'  ,
	      'begin',	'graph4_point_outline_color' , 'red' ,  '[color] of graph4 point outline'  ,
	      'begin',	'graph4_point_outline_width' , 1 ,  '[integer] thickness of graph4 point outline'  ,
	      'begin',	'graph4_point_size' , 2 ,  '[integer] radius size of graph 2 points'  ,
	      'begin',	'graph4_tick_color' , 	'black' ,  '[color] of graph4 vertical scale ticks'  ,
	      'begin',	'graph4_tick_length' , 	6 ,  '[integer] length of graph4 vertical scale ticks'  ,
	      'begin',	'graph4_tick_offset' , 5 ,  '[integer] horizontal offset of graph4 vertical scale ticks'  ,
	      'begin',	'graph4_tick_on' , 1 ,  '[0|1] toggles graph4 vertical scale ticks on and off'  ,
	      'begin',	'graph4_tick_width' , 	3 ,  '[integer] thickness of graph4 vertical scale ticks'  ,
	      'begin',	'graph4_vline_color' , 'black' ,  '[color] of graph4 vertical scale line'  ,
	      'begin',	'graph4_vline_on' , 1 ,  '[0|1] toggles graph4 vertical scale line off and on'  ,
	      'begin',	'graph4_vline_width' , 2 ,  '[integer] thickness of graph4 vertical scale line'  ,
...
sub indexcard_options {
  ...
  #print "DEPTH:$depth\n";
  foreach (@l) {
    $_->configure(-pady=>$depth-$br{$_}, -borderwidth=>$br{$_},-padx=>$depth-$br{$_});
  }
...
sub card_graph {
  ...
  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $tmp=$frame->Label(-text => "graph3", -background => '#ffff9d')->pack(-side=> 'left',-anchor => 'e');
  $ballooni->attach($tmp,-justify => 'left',
		    -msg=>("graph3  reates a numeric or categorical plot of sub-subjects below sequence:\n"
			   ."(N)umeric scale plots numeric values in a continous fashion                 \n"
			   ."(C)ategoric scale overlays a name for each step of the numeric scale        \n"
			   ."    categorical names are separated by commas (e.g. X,Y,1,2,3,4)            \n"
			   ."col and col2 choose columns containing y values to plot                     \n"
			   ...
			   ."   if col2 filled then seq2 will use col2 while col will be for seq1        \n"
			   ."                                                                             "));
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph3_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"Scale Values: min", 'graph3_min', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"Scale Values: min", 'graph3_max', 8 , \&redraw);

  #######################SCALES ##############################3
  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Point:")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'on',-variable => \$opt{'graph3_point_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_point_on') ) if $opt{'help_on'};
  #not a supported choice
  #$frame->Optionmenu(-textvariable=>\$opt{'graph3_point_shape'},-background=>'#bbe8ff' ,
  #		-options => ['Circle']
  #	)->pack(-side => 'left',-anchor=>'e');
  &fast_lentry($frame,$tmp,"point size", 'graph3_point_size', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"fill color", 'graph3_point_fill_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"outline: color", 'graph3_point_outline_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph3_point_outline_width', 3 , \&redraw);

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Connecting Line:")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'on',-variable => \$opt{'graph3_line_on'},)->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_line_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph3_line_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph3_line_width', 3 , \&redraw);
  $frame->Label(-text => "smoothing")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph3_line_smooth'}, )->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_line_smooth') ) if $opt{'help_on'};

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Vertical Line")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph3_vline_on'},)->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_vline_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph3_vline_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph3_vline_width', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph3_vline_offset', 3 , \&redraw);

  #######################
  $frame = $mw->Frame();
  $frame->Label(-text => "Tick Marks")->pack(-side=> 'left',-anchor => 'w');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph3_tick_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_tick_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph3_tick_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"length", 'graph3_tick_length', 4 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph3_tick_width', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph3_tick_offset', 3 , \&redraw);
  $frame->pack(-side => 'top', -expand=> 1,-anchor=>'w');

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Tick Labels")->pack(-side=> 'left',-anchor => 'w');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph3_label_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph3_label_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph3_label_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"size", 'graph3_label_fontsize', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph3_label_offset', 4 , \&redraw);

  $frame = $mw->Frame()->pack(-side=> 'top',-anchor => 'w');
  &fast_lentry($frame,$tmp,"     value_scaling", 'graph3_label_multiplier', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"decimal points", 'graph3_label_decimal', 14 , \&redraw);
  ...
  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $tmp=$frame->Label(-text => "graph4", -background => '#ffff9d')->pack(-side=> 'left',-anchor => 'e');
  $ballooni->attach($tmp,-justify => 'left',
		    -msg=>("graph4  reates a numeric or categorical plot of sub-subjects below sequence:\n"
			   ."(N)umeric scale plots numeric values in a continous fashion                 \n"
			   ."(C)ategoric scale overlays a name for each step of the numeric scale        \n"
			   ."    categorical names are separated by commas (e.g. X,Y,1,2,3,4)            \n"
			   ."col and col2 choose columns containing y values to plot                     \n"
			   ...
			   ."   if col2 filled then seq2 will use col2 while col will be for seq1        \n"
			   ."                                                                             "));
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph4_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"Scale Values: min", 'graph4_min', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"Scale Values: min", 'graph4_max', 8 , \&redraw);

  #######################SCALES ##############################3
  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Point:")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'on',-variable => \$opt{'graph4_point_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_point_on') ) if $opt{'help_on'};
  #not a supported choice
  #$frame->Optionmenu(-textvariable=>\$opt{'graph4_point_shape'},-background=>'#bbe8ff' ,
  #		-options => ['Circle']
  #	)->pack(-side => 'left',-anchor=>'e');
  &fast_lentry($frame,$tmp,"point size", 'graph4_point_size', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"fill color", 'graph4_point_fill_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"outline: color", 'graph4_point_outline_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph4_point_outline_width', 3 , \&redraw);

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Connecting Line:")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'on',-variable => \$opt{'graph4_line_on'},)->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_line_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph4_line_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph4_line_width', 3 , \&redraw);
  $frame->Label(-text => "smoothing")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph4_line_smooth'}, )->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_line_smooth') ) if $opt{'help_on'};

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Vertical Line")->pack(-side=> 'left',-anchor => 'e');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph4_vline_on'},)->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_vline_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph4_vline_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph4_vline_width', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph4_vline_offset', 3 , \&redraw);

  #######################
  $frame = $mw->Frame();
  $frame->Label(-text => "Tick Marks")->pack(-side=> 'left',-anchor => 'w');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph4_tick_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_tick_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph4_tick_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"length", 'graph4_tick_length', 4 , \&redraw);
  &fast_lentry($frame,$tmp,"width", 'graph4_tick_width', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph4_tick_offset', 3 , \&redraw);
  $frame->pack(-side => 'top', -expand=> 1,-anchor=>'w');

  $frame = $mw->Frame()->pack(-side => 'top', -expand=> 1,-anchor=>'w');
  $frame->Label(-text => "Tick Labels")->pack(-side=> 'left',-anchor => 'w');
  $tmp=$frame->Checkbutton(-text=>'ON',-variable => \$opt{'graph4_label_on'})->pack(-side=>'left',-anchor=>'e');
  $ballooni->attach($tmp, -msg => &balloon_format_var('graph4_label_on') ) if $opt{'help_on'};
  &fast_lentry($frame,$tmp,"color", 'graph4_label_color', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"size", 'graph4_label_fontsize', 3 , \&redraw);
  &fast_lentry($frame,$tmp,"offset", 'graph4_label_offset', 4 , \&redraw);

  $frame = $mw->Frame()->pack(-side=> 'top',-anchor => 'w');
  &fast_lentry($frame,$tmp,"     value_scaling", 'graph4_label_multiplier', 8 , \&redraw);
  &fast_lentry($frame,$tmp,"decimal points", 'graph4_label_decimal', 14 , \&redraw);
...
sub draw_scales {
  ...
  foreach (my $l=0; $l<@l; $l++) {
    ...
    if ( $opt {'graph_scale_on'} ) {
      ...
      my $intercept3=$opt{'graph3_min'};
      my $slope3=($opt{'graph3_max'}-$opt{'graph3_min'})/$opt{'graph_scale_height'};
      my $scale3= $opt{'graph_scale_height'} / ( $opt{'graph3_max'}-$opt{'graph3_min'} );

      my $intercept4=$opt{'graph4_min'};
      my $slope4=($opt{'graph4_max'}-$opt{'graph4_min'})/$opt{'graph_scale_height'};
      my $scale4= $opt{'graph_scale_height'} / ( $opt{'graph4_max'}-$opt{'graph4_min'} );
	...
	if ($opt{'graph3_on'} && $opt{'graph3_vline_on'}) {
	  my $tag=$canvas->createLine ( $xend,$i+$opt{'graph_scale_indent'},
					$xend,$i-$opt{'graph_scale_height'}+$opt{'graph_scale_indent'},
					-width => $opt{'graph3_vline_width'}, -fill => $opt{'graph3_vline_color'}
				      );
	  $canvas->addtag('gs','withtag',$tag);
	}

	if ($opt{'graph4_on'} && $opt{'graph4_vline_on'}) {
	  my $tag=$canvas->createLine ( $xend,$i+$opt{'graph_scale_indent'},
					$xend,$i-$opt{'graph_scale_height'}+$opt{'graph_scale_indent'},
					-width => $opt{'graph4_vline_width'}, -fill => $opt{'graph4_vline_color'}
				      );
	  $canvas->addtag('gs','withtag',$tag);
	}
	...
	for (my $j=0; $j<=$opt{'graph_scale_height'};$j+=$step) {
	  ...
	  if ($opt{'graph3_on'} && $opt{'graph3_tick_on'}) {
	    #print "DRAWING GSCALE1 TICK\n";
	    my $tag=$canvas->createLine($xend-$opt{'graph3_tick_length'}+$opt{'graph3_tick_offset'}, $y
					,$xend+$opt{'graph3_tick_offset'},$y,
					-width => $opt{'graph3_tick_width'}, -fill => $opt{'graph3_tick_color'}
				       );
	    $canvas->addtag('gs','withtag',$tag);
	  }

	  if ($opt{'graph4_on'} && $opt{'graph4_tick_on'}) {
	    #print "DRAWING GSCALE1 TICK\n";
	    my $tag=$canvas->createLine($xend-$opt{'graph4_tick_length'}+$opt{'graph4_tick_offset'}, $y
					,$xend+$opt{'graph4_tick_offset'},$y,
					-width => $opt{'graph4_tick_width'}, -fill => $opt{'graph4_tick_color'}
				       );
	    $canvas->addtag('gs','withtag',$tag);
	  }
	  ...
	  if ($opt{'graph3_on'} && $opt{'graph3_label_on'}) {
	    my $label=$j*$slope3+$intercept3; ;
	    $label=int($label* $opt{'graph3_label_multiplier'}*10**$opt{'graph3_label_decimal'}+0.00000000000001 )/10**$opt{'graph3_label_decimal'};
	    my $tag=$canvas->createText(
					$xend-$opt{'graph3_tick_length'}+$opt{'graph3_tick_offset'}-2+$opt{'graph3_label_offset'}, $y,
					-text=>$label,
					-font=>"Courier $opt{'graph3_label_fontsize'}",
					-fill=> $opt{'graph3_label_color'},-anchor=>"w");
	    $canvas->addtag('gsl','withtag',$tag);
	  }


	  if ($opt{'graph4_on'} && $opt{'graph4_label_on'}) {
	    my $label=$j*$slope4+$intercept4; ;
	    $label=int($label* $opt{'graph4_label_multiplier'}*10**$opt{'graph4_label_decimal'}+0.00000000000001 )/10**$opt{'graph4_label_decimal'};
	    my $tag=$canvas->createText(
					$xend-$opt{'graph4_tick_length'}+$opt{'graph4_tick_offset'}-2+$opt{'graph4_label_offset'}, $y,
					-text=>$label,
					-font=>"Courier $opt{'graph4_label_fontsize'}",
					-fill=> $opt{'graph4_label_color'},-anchor=>"w");
	    $canvas->addtag('gsl','withtag',$tag);
	  }
...
sub draw_pairwise {
  ...
  for (my $i=0; $i < $size;$i++) {
    ...
    if ($opt{'pair_level'} eq 'inter_over_intra' ) {
      if ($pairtype eq 'inter') {
	$canvas->raise($tagname);
      } else {
	$canvas->lower($tagname);
      }
...
sub draw_graph {
  foreach my $numb (1,2,3,4) {	#graph1 graph2 graph3 gragh4
    my $array = "g$numb";
	...
	if ($i< $size-1) {
	  ($x2,$y2)=&linexbp2xy($acc{$seq}{'l'},$acc{$seq}{'xb'} + $$p[$i+1][1] - $acc{$seq}{'b'})
				...
				#print "x1:$x1,x2:$x2,y1:$y1,y2:$y2 $y1 ne $y2   $seq ne $$p[$i+1][0] $$p[$i+1][1] > $acc{$seq}{'e'}\n";
	if ( $i == $size-1 || $y1 ne $y2 || $seq ne $$p[$i+1][0]
	     || $$p[$i+1][1] > $acc{$seq}{'e'} || $val eq '') {
				#draw lines
	  #print "DRAWING LINES, \@line is @line lincolor is $line_color width: $line_width smooth: $line_smooth\n";
	  if (@line >= 4) {
	    #print "111111\n";
...
sub arrange_subjects {
  ...
  if ($opt{'arrangesub'} =~/subscaleC/ ) {
    ...
    for (my $i=0;$i<@subscaleC;$i++) {
      $subscaleC{$subscaleC[$i]}=$i;
    }
...
sub show_calculations {
  ...
  for (my $i=0; $i<@m; $i++) {
	...
	$accsub{$n1}{'acc'}{$n2}{'eghit'} = $i;
      ...
      if ( $b<$accsub{$n1}{'acc'}{$n2}{'qmin'} ) {
	$accsub{$n1}{'acc'}{$n2}{'qmin'}= $b ;
      }
      if ($e>$accsub{$n1}{'acc'}{$n2}{'qmax'} ) {
	$accsub{$n1}{'acc'}{$n2}{'qmax'}= $e ;
      }
	...
	$accsub{$n2}{'acc'}{$n1}{'eghit'} = $i;
      ...
      if ( $b<$accsub{$n2}{'acc'}{$n1}{'qmin'} ) {
	$accsub{$n2}{'acc'}{$n1}{'qmin'}= $b ;
      }
      if ( $e>$accsub{$n2}{'acc'}{$n1}{'qmax'} ) {
	$accsub{$n2}{'acc'}{$n1}{'qmax'}= $e ;
      }
    }
...
sub graph_update {
  ...
  #	@g1 and @g2  # plus g3 and g4
  print "UPDATING GRAPH DATA\n"  if !$newopt{'quiet'};
  foreach my $g ( 1, 2, 3, 4  ) { #graph1 graph2 graph3 gragh4
...
sub save_parasight_table {
  ...
  my $max=@g1;
  $max=@g2 if @g2 > $max;	#graph1 graph2 graph3 gragh4
  $max=@g3 if @g3 > $max;
  $max=@g4 if @g4 > $max;
  ...
  if ($max > 0 ) {
	...
	print OUT "\t\t\t";
      ...
      if (defined $g2[$i]) {	#graph1 graph2 graph3 gragh4
	print OUT "\t$g2[$i][0]\t$g2[$i][1]\t$g2[$i][2]\n";
      } else {
	print OUT "\t\t\t\n";
      }
      if (defined $g3[$i]) {	#graph1 graph2 graph3 gragh4
	print OUT "\t$g3[$i][0]\t$g3[$i][1]\t$g3[$i][2]\n";
      } else {
	print OUT "\t\t\t\n";
      }
      if (defined $g4[$i]) {	#graph1 graph2 graph3 gragh4
	print OUT "\t$g4[$i][0]\t$g4[$i][1]\t$g4[$i][2]\n";
      } else {
	print OUT "\t\t\t\n";
      }
...
sub load_option_template {
  ...
  while (<OPTION>) {
    ...
    next if $_=~/^#/;
    next if $_ eq 'showseq' || $_ eq 'in' || $_ eq 'align' || $_ eq 'extra' || $_ eq 'showsub' || $_ eq 'graph1' || $_ eq 'graph2' || $_ eq 'graph3' || $_ eq 'graph4';
    $opt{$c[0]}=$c[1];
  }
  close OPTION;
...
sub load_parasight_table {
  ...
  ####### LOAD .psg ######
  @g1=();
  @g2=();			#graph1 graph2 graph3 gragh4
  @g3=();
  @g4=();
  if (open (IN, "$name.psg")   ) {
    my $header=<IN>;
    while (<IN>) {
      ...
      push @g2, [ $c[3], $c[4], $c[5] ] if $c[3] ne '';	#graph1 graph2 graph3 gragh4
      push @g3, [ $c[6], $c[7], $c[8] ] if $c[6] ne '';
      push @g3, [ $c[9], $c[10], $c[11] ] if $c[9] ne '';
    }
    close IN;
  } else {
  }
...
sub print_all {
  ...
  print '=' x 80, "\nbox[0]=$box[0], box[1]=$box[1], box[2]=$box[2], box[3]=$box[3]\n";
  my $xpage=0;
  my $ypage=0;
...
=item * C<graph3_label_color>=E<gt>C<red>S<     >[color] of graph3 scale labels

=item * C<graph3_label_decimal>=E<gt>C<2>S<     >[integer] number of decimal point to round graph3 scale label

=item * C<graph3_label_fontsize>=E<gt>C<10>S<     >[integer] point size of graph3 scale labels

=item * C<graph3_label_multiplier>=E<gt>C<1>S<     >[float] graph3 scale label multiplier

=item * C<graph3_label_offset>=E<gt>C<8>S<     >[integer] horizontal offset of graph3 scale labels

=item * C<graph3_label_on>=E<gt>C<1>S<     >[0|1] toggles graph3 scale labels off and n

=item * C<graph3_line_color>=E<gt>C<red>S<     >[color] of graph3 connecting lines

=item * C<graph3_line_on>=E<gt>C<1>S<     >[0|1] toggles graph3 connecting lines off and on

=item * C<graph3_line_smooth>=E<gt>C<0>S<     >[0|1] toggles graph3 connecting line smoothing off and on

=item * C<graph3_line_width>=E<gt>C<1>S<     >[integer] thickness of graph3 connecting lines

=item * C<graph3_max>=E<gt>C<1000>S<     >[integer] maximum value for graph3 scale

=item * C<graph3_min>=E<gt>C<-1000>S<     >[integer] minimum value for graph3 scale

=item * C<graph3_on>=E<gt>C<0>S<     >[0|1] toggles graph3_on

=item * C<graph3_point_fill_color>=E<gt>C<red>S<     >[color] of interior of graph3 points

=item * C<graph3_point_on>=E<gt>C<1>S<     >[0|1] toggles graph3 point drawing on and off

=item * C<graph3_point_outline_color>=E<gt>C<red>S<     >[color] of graph3 point outline

=item * C<graph3_point_outline_width>=E<gt>C<1>S<     >[integer] thickness of graph3 point outline

=item * C<graph3_point_size>=E<gt>C<2>S<     >[integer] radius size of graph 2 points

=item * C<graph3_tick_color>=E<gt>C<black>S<     >[color] of graph3 vertical scale ticks

=item * C<graph3_tick_length>=E<gt>C<6>S<     >[integer] length of graph3 vertical scale ticks

=item * C<graph3_tick_offset>=E<gt>C<5>S<     >[integer] horizontal offset of graph3 vertical scale ticks

=item * C<graph3_tick_on>=E<gt>C<1>S<     >[0|1] toggles graph3 vertical scale ticks on and off

=item * C<graph3_tick_width>=E<gt>C<3>S<     >[integer] thickness of graph3 vertical scale ticks

=item * C<graph3_vline_color>=E<gt>C<black>S<     >[color] of graph3 vertical scale line

=item * C<graph3_vline_on>=E<gt>C<1>S<     >[0|1] toggles graph3 vertical scale line off and on

=item * C<graph3_vline_width>=E<gt>C<2>S<     >[integer] thickness of graph3 vertical scale line

=item * C<graph4_label_color>=E<gt>C<red>S<     >[color] of graph4 scale labels

=item * C<graph4_label_decimal>=E<gt>C<2>S<     >[integer] number of decimal point to round graph4 scale label

=item * C<graph4_label_fontsize>=E<gt>C<10>S<     >[integer] point size of graph4 scale labels

=item * C<graph4_label_multiplier>=E<gt>C<1>S<     >[float] graph4 scale label multiplier

=item * C<graph4_label_offset>=E<gt>C<8>S<     >[integer] horizontal offset of graph4 scale labels

=item * C<graph4_label_on>=E<gt>C<1>S<     >[0|1] toggles graph4 scale labels off and n

=item * C<graph4_line_color>=E<gt>C<red>S<     >[color] of graph4 connecting lines

=item * C<graph4_line_on>=E<gt>C<1>S<     >[0|1] toggles graph4 connecting lines off and on

=item * C<graph4_line_smooth>=E<gt>C<0>S<     >[0|1] toggles graph4 connecting line smoothing off and on

=item * C<graph4_line_width>=E<gt>C<1>S<     >[integer] thickness of graph4 connecting lines

=item * C<graph4_max>=E<gt>C<1000>S<     >[integer] maximum value for graph4 scale

=item * C<graph4_min>=E<gt>C<-1000>S<     >[integer] minimum value for graph4 scale

=item * C<graph4_on>=E<gt>C<0>S<     >[0|1] toggles graph4_on

=item * C<graph4_point_fill_color>=E<gt>C<red>S<     >[color] of interior of graph4 points

=item * C<graph4_point_on>=E<gt>C<1>S<     >[0|1] toggles graph4 point drawing on and off

=item * C<graph4_point_outline_color>=E<gt>C<red>S<     >[color] of graph4 point outline

=item * C<graph4_point_outline_width>=E<gt>C<1>S<     >[integer] thickness of graph4 point outline

=item * C<graph4_point_size>=E<gt>C<2>S<     >[integer] radius size of graph 2 points

=item * C<graph4_tick_color>=E<gt>C<black>S<     >[color] of graph4 vertical scale ticks

=item * C<graph4_tick_length>=E<gt>C<6>S<     >[integer] length of graph4 vertical scale ticks

=item * C<graph4_tick_offset>=E<gt>C<5>S<     >[integer] horizontal offset of graph4 vertical scale ticks

=item * C<graph4_tick_on>=E<gt>C<1>S<     >[0|1] toggles graph4 vertical scale ticks on and off

=item * C<graph4_tick_width>=E<gt>C<3>S<     >[integer] thickness of graph4 vertical scale ticks

=item * C<graph4_vline_color>=E<gt>C<black>S<     >[color] of graph4 vertical scale line

=item * C<graph4_vline_on>=E<gt>C<1>S<     >[0|1] toggles graph4 vertical scale line off and on

=item * C<graph4_vline_width>=E<gt>C<2>S<     >[integer] thickness of graph4 vertical scale line
...
B<graph3_label_color>=E<gt>C<red>S<  >
B<graph3_label_decimal>=E<gt>C<2>S<  >
B<graph3_label_fontsize>=E<gt>C<10>S<  >
B<graph3_label_multiplier>=E<gt>C<1>S<  >
B<graph3_label_offset>=E<gt>C<8>S<  >
B<graph3_label_on>=E<gt>C<1>S<  >
B<graph3_line_color>=E<gt>C<red>S<  >
B<graph3_line_on>=E<gt>C<1>S<  >
B<graph3_line_smooth>=E<gt>C<0>S<  >
B<graph3_line_width>=E<gt>C<1>S<  >
B<graph3_max>=E<gt>C<1000>S<  >
B<graph3_min>=E<gt>C<-1000>S<  >
B<graph3_on>=E<gt>C<0>S<  >
B<graph3_point_fill_color>=E<gt>C<red>S<  >
B<graph3_point_on>=E<gt>C<1>S<  >
B<graph3_point_outline_color>=E<gt>C<red>S<  >
B<graph3_point_outline_width>=E<gt>C<1>S<  >
B<graph3_point_size>=E<gt>C<2>S<  >
B<graph3_tick_color>=E<gt>C<black>S<  >
B<graph3_tick_length>=E<gt>C<6>S<  >
B<graph3_tick_offset>=E<gt>C<5>S<  >
B<graph3_tick_on>=E<gt>C<1>S<  >
B<graph3_tick_width>=E<gt>C<3>S<  >
B<graph3_vline_color>=E<gt>C<black>S<  >
B<graph3_vline_on>=E<gt>C<1>S<  >
B<graph3_vline_width>=E<gt>C<2>S<  >
B<graph4_label_color>=E<gt>C<red>S<  >
B<graph4_label_decimal>=E<gt>C<2>S<  >
B<graph4_label_fontsize>=E<gt>C<10>S<  >
B<graph4_label_multiplier>=E<gt>C<1>S<  >
B<graph4_label_offset>=E<gt>C<8>S<  >
B<graph4_label_on>=E<gt>C<1>S<  >
B<graph4_line_color>=E<gt>C<red>S<  >
B<graph4_line_on>=E<gt>C<1>S<  >
B<graph4_line_smooth>=E<gt>C<0>S<  >
B<graph4_line_width>=E<gt>C<1>S<  >
B<graph4_max>=E<gt>C<1000>S<  >
B<graph4_min>=E<gt>C<-1000>S<  >
B<graph4_on>=E<gt>C<0>S<  >
B<graph4_point_fill_color>=E<gt>C<red>S<  >
B<graph4_point_on>=E<gt>C<1>S<  >
B<graph4_point_outline_color>=E<gt>C<red>S<  >
B<graph4_point_outline_width>=E<gt>C<1>S<  >
B<graph4_point_size>=E<gt>C<2>S<  >
B<graph4_tick_color>=E<gt>C<black>S<  >
B<graph4_tick_length>=E<gt>C<6>S<  >
B<graph4_tick_offset>=E<gt>C<5>S<  >
B<graph4_tick_on>=E<gt>C<1>S<  >
B<graph4_tick_width>=E<gt>C<3>S<  >
B<graph4_vline_color>=E<gt>C<black>S<  >
B<graph4_vline_on>=E<gt>C<1>S<  >
B<graph4_vline_width>=E<gt>C<2>S<  >
