...
perl ./writeArrangeUsngLoop.pl showseq_fake_chromosome.out > arrange.out
...
../parasight751_4graph.pl -extra ../wgac5k.extra \
    ...
    -showseq ../showseq_fake_chromosome.out -arrangeseq  file:../arrange.out \
...
#     5kgap.extra 1000 0.90 chr1 1 ../showseq_fake_chromosome.out
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull \
    5kgap.extra 1000 0.90 chr1 1 ../showseq_fake_chromosome.out

# 5 kb
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 5000 0.90 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 5000 0.94 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 5000 0.98 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 5000 0.99 all 1 ../showseq_fake_chromosome.out

# 10 kb

../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 10000 0.90 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 10000 0.94 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 10000 0.98 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 10000 0.99 all 1 ../showseq_fake_chromosome.out

# 20 kb

../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 20000 0.90 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 20000 0.94 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 20000 0.98 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 20000 0.99 all 1 ../showseq_fake_chromosome.out

# 40 kb

../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 40000 0.90 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 40000 0.94 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 40000 0.98 all 1 ../showseq_fake_chromosome.out
 
../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 40000 0.99 all 1 ../showseq_fake_chromosome.out

../chromosome_blowups.pl ../data/oo.weild10kb.join.all.cull 5kgap.extra 100000 0.95 all 1 ../showseq_fake_chromosome.out
